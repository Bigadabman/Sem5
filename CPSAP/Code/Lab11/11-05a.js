    ...
    ws.login({login:'keo', password:'1111'})
        .then((login) => {
            if(login){
                ...
                ws.call('fact', [5]).catch((e) => { console.log('fact error: ', e)}).then((r) => { console.log('fact(5) = ', r)});
                ws.call('fact', [10]).catch((e) => { console.log('fact error: ', e)}).then((r) => { console.log('fact(10) = ', r)});
            }
            else{
